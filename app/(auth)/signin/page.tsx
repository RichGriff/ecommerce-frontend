      ...
      <div className="flex min-h-screen flex-1">
          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              <div className="flex justify-start items-center gap-4">
                <Link href={'/'} className="hover:bg-slate-50 p-2 rounded-lg transition-all"><MoveLeft className='w-6 h-6'/></Link>
              ...
              <p className="mt-2 text-sm leading-6 text-gray-500">
                Not a member? <Link href={'register'} className="text-indigo-600 font-semibold">Create an account</Link>{' '}
              </p>
            </div>
        ...
        <div className="relative hidden w-0 flex-1 lg:block lg:w-1/2">
          <img
            ...
            src="https://images.unsplash.com/photo-1646954640942-25bf3047e5e6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
        </div>
      </div>
