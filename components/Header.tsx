  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative overflow-hidden mb-8">
        {/* Company Nav */}
        <nav className='bg-slate-900 w-full py-2 text-sm text-white'>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex justify-end items-center gap-6">
              {navigation.pages.map(page => (
                <Link key={crypto.randomUUID()} href={page.href}>
                  {page.name}
                </Link>
              ))}
            </div>
        ...
        {/* Top navigation */}
        <nav aria-label="Top" className="relative z-20 bg-white bg-opacity-80 backdrop-blur-sm backdrop-filter">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  {/* <img
                    ...
                    alt=""
                  /> */}
                  <span className='font-bold text-slate-900 text-xl'>Budda.</span>
                </a>
              </div>
              ...
              <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch">
                <div className="flex h-full space-x-8">
                  {navigation.categories.map((category) => (
                    <Link key={category.id} href={category.id} className='border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out'>
                      {category.name}
                    </Link>
